var icon1arr = [
  {
    ...
    photo:
      "https://static.frontendmasters.com/assets/teachers/gandolfo/thumb.webp",
  ...
  },
  {
    ...
    head1: "Editor's Notes",
    de: "Will’s course emphasizes not only understanding JavaScript, but also communicating your understanding of the language’s most important concepts. Communicating is a necessary skill for becoming a high-performing engineer.",
  },
  {
    ...
    de: "Kyle’s course builds by reinforcing many of the foundational concepts covered in Will’s course, but goes even deeper. He also covers types and the type coercion that goes on under the hood of JavaScript.",
    head1: "Editor's Notes",
  },
  {
    ...
    head1: "Editor's Notes",
    de: "Modern JavaScript builds on top of the foundations and adds more to the language. Kyle’s JavaScript the Recent Parts course will give you a deeper understanding those newer features added to the JavaScrip",
  },
  {
    ...
    head1: "Editor's Notes",
    de: "Understanding asynchronous and functional programming deeply will increase your programming abilities drastically. The first course is part 2 of Will’s “Hard Parts” series. With this one, he’s focusing on the new asynchronous features in JavaScript.",
  },
  {
    ...
    head1: "Editor's Notes",
    de: "Functional programming is a set of tools such as map/reduce/filter, pure functions, and immutability. These tools are sure to make you a more effective developer through composing pure functions together to write more predictable and bug-free code.",
  },
  {
    ...
    head1: "Editor's Notes",
    de: "There’s a push with new languages that compile to JavaScript which are born of a functional nature like Elm and PureScript. In this course, we see how far we can take pure JavaScript towards more traditional functional programming.",
  },
  {
    ...
    head1: "Editor's Notes",
    de: "When you add lots of dynamic functionality with JavaScript, it’s important to keep your web apps accessible through announcing changes and focusable elements to screen readers and accommodate those with disabilities.",
  },
];
