...
let learn_data = [
  {
    title: "Beginner",
    desc: "Your Path to Becoming a Career-Ready Web Developer!",
    color: "#c94f17",
    img: "",
  ...
  {
    title: "Professional",
    desc: "Go From Professional Web Developer to Lead Engineer",
    color: "#c94f17",
    img: "",
  ...
  {
    title: "Expert",
    desc: "Mind-Expanding Web Development Techniques to Emerging APIs in the Web Browser",
    color: "#c94f17",
    img: "",
  ...
  },
  {
    ...
    desc: "Learning Computer Science with JavaScript",
    color: "#c94f17",
    img: "",
  ...
  {
    title: "Fullstack",
    desc: "Expand Your Abilities and Master the Server",
    color: "#c94f17",
    img: "",
  ...
  },
  {
    ...
    desc: "Make Your Designs Come to Life Through Code!",
    color: "#c94f17",
    img: "",
...
c0.006,0.347,0.01,0.688,0.01,1.022c0,1-0.03,1.973-0.089,2.893C45.954,19.886,46.372,20.362,46.923,20.397z"
  ></path>
  <path
    d="M20,46.959l15,6.177V9.805L20,1.864V46.959z M22,5.186l11,5.824v39.14l-11-4.53V5.186z"
  ></path>
  <path
    d="M37,9.805v43.331l17-7.177V0.864L37,9.805z M52,44.633l-13,5.488V11.013l13-6.837V44.633z"
  ></path>
</g>
</svg>`;

let topic_icon = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"><defs><linearGradient id="electives-linear" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#00505f"></stop><stop offset="100%" stop-color="#01d9ff"></stop></linearGradient></defs><g fill="url(#electives-linear)"><path d="M256,0C148.477,0,61,87.477,61,195c0,68.893,35.912,129.557,90,164.254V497c0,5.532,3.045,10.615,7.922,13.225
...
let elective_data = [
  ...
  {
    title: "CSS",
    desc: "Learn CSS, from Laying Out Websites to Performant Animations",
    color: "#c94f17",
    img: "https://iconape.com/wp-content/files/dj/370768/png/370768.png",
    icon: ``,
    class: "css",
  },
  {
    title: "Node.js",
    desc: "Build Web APIs and Applications with Node.js",
    color: "#c94f17",
    img: "https://iconape.com/wp-content/files/kk/353117/png/node-node-js-logo.png",
    icon: ``,
    class: "node",
  },
  {
    title: "React.js",
    desc: "Be Productive with React.js, Today's Most Popular Framework",
    color: "#c94f17",
  ...
  {
    title: "Vue.js",
    desc: "Learn Vue.js, An Easy to Pick Up and Powerful Framework",
    color: "#c94f17",
    img: "https://iconape.com/wp-content/files/ep/353380/png/vuejs-logo.png",
    icon: ``,
    class: "vue",
  },
  {
    title: "Angular",
    desc: "Learn Angular, a TypeScript-based web application framework led by Google",
    color: "#c94f17",
    img: "https://iconape.com/wp-content/files/mm/370537/png/370537.png",
    icon: ``,
    class: "angular",
  },
];

localStorage.setItem("elective_data", JSON.stringify(elective_data));
localStorage.setItem("topic_icon", topic_icon);
localStorage.setItem("map_svg", map_svg);
localStorage.setItem("learn_data", JSON.stringify(learn_data));
